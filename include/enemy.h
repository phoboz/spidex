...
#define ENEMY_STATUS_PROJECTILE		0x04
...
#define ENEMY_RACE_DRAGONFLYB	7
#define ENEMY_RACE_ANT			8
#define ENEMY_RACE_SPIT_ANT		9
#define ENEMY_RACE_SWALLOW		10
#define ENEMY_RACE_SPIKEY		11
#define ENEMY_RACE_STUMP		12
