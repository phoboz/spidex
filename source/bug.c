...
{	(signed char) +1, +6*BLOW_UP, +0*BLOW_UP, // sync and move to y, x
...
{	(signed char) +1, +0*BLOW_UP, -6*BLOW_UP, // sync and move to y, x
	(signed char) +0, +0*BLOW_UP, -6*BLOW_UP, // additional sync move to y, x
...
{	(signed char) +1, +9*BLOW_UP, -10*BLOW_UP, // sync and move to y, x
	...
	(signed char) -1, +0*BLOW_UP, -10*BLOW_UP, // draw, y, x
	(signed char) +0, -8*BLOW_UP, +7*BLOW_UP, // mode, y, x
	(signed char) -1, +4*BLOW_UP, -1*BLOW_UP, // draw, y, x
	(signed char) -1, +4*BLOW_UP, +3*BLOW_UP, // draw, y, x
	(signed char) +0, +0*BLOW_UP, -2*BLOW_UP, // mode, y, x
	(signed char) -1, +8*BLOW_UP, -3*BLOW_UP, // draw, y, x
