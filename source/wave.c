...
const struct wave_element wave_7[] =
{
	...
	{	180,			80,		-80,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},
	{	180,			-80,		-80,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},
	{	180,			-80,		80,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},
	{	0,			-100,	80,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_MINE,		2,	0	},
	{	180,			60,		60,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},
	{	180,			60,		-60,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},
	{	180,			-60,		-60,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},
	{	180,			-60,		60,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},
	{	0,			100,		-80,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_MINE,		4,	0	},
	{	180,			40,		40,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},
	{	180,			40,		-40,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},
	{	180,			-40,		-40,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},
	{	180,			-40,		40,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	},

	{	0,			-32,		32,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_MINE,		12,	0	},
	{	80,			0,		0,		WAVE_OBJECT_TYPE_DEWALL,	17,					0,	0	},
	{	0,			0,		0,		WAVE_OBJECT_TYPE_WALL,		24,					0,	0	},
	{	0,			0,		0,		WAVE_OBJECT_TYPE_WALL,		25,					0,	0	},
	{	0,			32,		32,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_MINE,		14,	0	},
	{	80,			0,		0,		WAVE_OBJECT_TYPE_DEWALL,	19,					0,	0	},
	{	0,			0,		0,		WAVE_OBJECT_TYPE_WALL,		26,					0,	0	},
	{	0,			0,		0,		WAVE_OBJECT_TYPE_WALL,		27,					0,	0	},
	{	0,			32,		-32,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_MINE,		16,	0	},
	{	80,			0,		0,		WAVE_OBJECT_TYPE_DEWALL,	21,					0,	0	},
	{	0,			0,		0,		WAVE_OBJECT_TYPE_WALL,		28,					0,	0	},
	{	0,			0,		0,		WAVE_OBJECT_TYPE_WALL,		29,					0,	0	},
	{	0,			-32,		-32,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_MINE,		18,	0	},
	{	80,			0,		0,		WAVE_OBJECT_TYPE_DEWALL,	23,					0,	0	},
	{	0,			0,		0,		WAVE_OBJECT_TYPE_WALL,		30,					0,	0	},
	{	0,			0,		0,		WAVE_OBJECT_TYPE_WALL,		31,					0,	0	},

	{	0,			-100,	-100,	WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SPIKEY,		0,	4	},
	{	0,			0,		-100,	WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SPIKEY,		0,	4	},
	{	0,			100,		-100,	WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SPIKEY,		0,	4	},
	{	0,			100,		0,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SPIKEY,		0,	4	},
	{	0,			100,		100,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SPIKEY,		0,	4	},
	{	0,			0,		100,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SPIKEY,		0,	4	},
	{	0,			-100,	100,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SPIKEY,		0,	4	},
	{	0,			-100,	0,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SPIKEY,		0,	4	},

	{	40,			0,		0,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_ANT,		0,	14	}
};
...
const struct wave_element wave_8[] =
{
	...
	{	0,			0,		0,		WAVE_OBJECT_TYPE_WALL,		30,					0,	0	},
	{	0,			0,		0,		WAVE_OBJECT_TYPE_WALL,		31,					0,	0	},
	{	60,			6,		-28,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	1,	0	},
	{	60,			12,		-56,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	8,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	9,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	10,	0	},
	{	0,			-16,		-16,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	18,	0	},
	{	60,			6,		-28,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	1,	0	},
	{	60,			12,		-56,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	8,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	9,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	10,	0	},
	{	0,			0,		-16,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	17,	0	},
	{	60,			6,		-28,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	1,	0	},
	{	60,			12,		-56,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	8,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	9,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	10,	0	},
	{	0,			16,		-16,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	16,	0	},
	{	60,			6,		-28,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	1,	0	},
	{	60,			12,		-56,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	8,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	9,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	10,	0	},
	{	0,			16,		0,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	15,	0	},
	{	60,			6,		-28,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	1,	0	},
	{	60,			12,		-56,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	8,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	9,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	10,	0	},
	{	0,			16,		16,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	14,	0	},
	{	60,			6,		-28,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	1,	0	},
	{	60,			12,		-56,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	8,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	9,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	10,	0	},
	{	0,			0,		16,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	13,	0	},
	{	60,			6,		-28,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	1,	0	},
	{	60,			12,		-56,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	8,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	9,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	10,	0	},
	{	0,			-16,		16,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	12,	0	},
	{	60,			6,		-28,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	1,	0	},
	{	60,			12,		-56,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	8,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	9,	0	},
	{	60,			18,		-84,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	10,	0	},
	{	0,			-16,		0,		WAVE_OBJECT_TYPE_ENEMY,	ENEMY_RACE_SWALLOW,	11,	0	}
};
