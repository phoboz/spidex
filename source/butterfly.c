...
{	(signed char) +1, +10*BLOW_UP, -6*BLOW_UP, // sync and move to y, x
...
{	(signed char) +1, +3*BLOW_UP, -10*BLOW_UP, // sync and move to y, x
...
{	(signed char) +1, -6*BLOW_UP, -10*BLOW_UP, // sync and move to y, x
...
{	(signed char) +1, -10*BLOW_UP, -3*BLOW_UP, // sync and move to y, x
...
{	(signed char) +1, -8*BLOW_UP, +1*BLOW_UP, // sync and move to y, x
...
{	(signed char) +1, -5*BLOW_UP, +6*BLOW_UP, // sync and move to y, x
	(signed char) -1, +4*BLOW_UP, -7*BLOW_UP, // draw, y, x
	(signed char) -1, +7*BLOW_UP, -4*BLOW_UP, // draw, y, x
	(signed char) -1, +2*BLOW_UP, +2*BLOW_UP, // draw, y, x
	(signed char) -1, +7*BLOW_UP, +1*BLOW_UP, // draw, y, x
